          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm col-span-2">
              ...
              <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-xs text-slate-600">
                ...
                <div><span class="font-bold text-slate-400 block">Année:</span> <span class="font-semibold text-slate-900" id="v-annee">${r.annee_vehicule || 'Inconnue'}</span></div>
              </div>
              ...
              <form id="vehicle-edit-form" class="hidden mt-4 pt-4 border-t border-dashed bg-slate-50 p-3 rounded-lg space-y-3" onsubmit="saveVehicleEdit(event, ${r.id})">
                ...
                <div class="grid grid-cols-3 gap-2">
                  ...
                  <input type="text" id="edit-v-circulation" placeholder="Date Circulation" value="${r.date_circulation || ''}" class="p-1 px-2 text-xs border rounded w-full">
